...
namespace Rhetos.MvcModelGenerator.DefaultConcepts
{
    ...
    public class MoneyPropertyCodeGenerator : IMvcModelGeneratorPlugin
    {
        static SimpleOverridableAttribute _formatAttribute = new SimpleOverridableAttribute("DataType", false);
