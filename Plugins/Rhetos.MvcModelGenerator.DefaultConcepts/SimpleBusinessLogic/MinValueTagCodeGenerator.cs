...
namespace Rhetos.MvcModelGenerator.DefaultConcepts
{
    ...
    public class MinValueTagCodeGenerator : IMvcModelGeneratorPlugin
    {
        static OverridableAttribute<int> _overridableAttributeInteger = new OverridableAttribute<int>(
            "Rhetos.Mvc.MinValueInteger", (oldValue, newValue) => newValue > oldValue, str => int.Parse(str));

        static OverridableAttribute<decimal> _overridableAttributeDecimal = new OverridableAttribute<decimal>(
            "Rhetos.Mvc.MinValueDecimal", (oldValue, newValue) => newValue > oldValue, str => decimal.Parse(str));

        static OverridableAttribute<DateTime> _overridableAttributeDateTime = new OverridableAttribute<DateTime>(
            "Rhetos.Mvc.MinValueDateTime", (oldValue, newValue) => newValue > oldValue, str => DateTime.Parse(str));
