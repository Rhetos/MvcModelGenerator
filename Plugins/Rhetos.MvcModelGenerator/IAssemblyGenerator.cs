...
namespace Rhetos.MvcModelGenerator
{
    ...
    public interface IAssemblyGenerator
    {
        ...
        /// </param>
        Assembly Generate(Rhetos.Compiler.IAssemblySource assemblySource, string outputAssemblyPath, IEnumerable<ManifestResource> manifestResources = null);
        ...
        Assembly Generate(Rhetos.Compiler.IAssemblySource assemblySource, CompilerParameters compilerParameters);
    }
}