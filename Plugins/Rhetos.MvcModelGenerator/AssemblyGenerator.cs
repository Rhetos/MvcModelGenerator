...
namespace Rhetos.MvcModelGenerator
{
    public class AssemblyGenerator : IAssemblyGenerator
    {
        ...
        public AssemblyGenerator(ILogProvider logProvider,
            ...
            FilesUtility filesUtility, MvcModelGeneratorOptions mvcModelGeneratorOptions)
        {
            _performanceLogger = logProvider.GetLogger("Performance." + GetType().Name);
            _logger = logProvider.GetLogger("AssemblyGenerator");
            _buildOptions = buildOptions;
            _errorReportLimit = mvcModelGeneratorOptions.AssemblyGeneratorErrorReportLimit;
        ...
        public Assembly Generate(Rhetos.Compiler.IAssemblySource assemblySource, CompilerParameters compilerParameters)
        {
        ...
        public Assembly Generate(Rhetos.Compiler.IAssemblySource assemblySource, string outputAssemblyPath, IEnumerable<ManifestResource> manifestResources = null)
        {
