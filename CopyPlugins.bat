...
XCOPY /Y/D/R %ThisScriptFolder%Plugins\Rhetos.Mvc.Client\bin\%2\Rhetos.Mvc.Client.dll %1 || EXIT /B 1
XCOPY /Y/D/R %ThisScriptFolder%Plugins\Rhetos.Mvc.Client\bin\%2\Rhetos.Mvc.Client.pdb %1 || EXIT /B 1
